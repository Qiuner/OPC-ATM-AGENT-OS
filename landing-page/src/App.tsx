  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        {/* ATM hero: left text + right OS (OS height = 3-line text height) */}
        <div className="flex items-stretch gap-4 md:gap-6 text-left max-w-6xl mx-auto w-full" style={{ animation: 'fade-up 0.8s ease-out' }}>
          {/* Left: Agent To Marketing */}
          <h1 className="font-extrabold leading-[0.92] shrink-0" style={{ letterSpacing: '-0.05em', fontSize: 'clamp(48px, 7.5vw, 96px)' }}>
          ...
          {/* Right: OS stretches to match left height */}
          <div className="flex items-center justify-center">
            <span className="gradient-text font-extrabold leading-none" style={{ fontSize: 'clamp(100px, 16vw, 220px)', letterSpacing: '-0.06em' }}>OS</span>
          </div>
        </div>

        {/* Subtitle */}
        <div className="mt-8 text-xl md:text-2xl lg:text-3xl font-semibold text-white/90 text-left max-w-6xl mx-auto" style={{ animation: 'fade-up 1s ease-out' }}>
        ...
        <p className="mt-6 text-base md:text-lg text-gray-400 max-w-6xl mx-auto leading-relaxed text-left" style={{ animation: 'fade-up 1.2s ease-out' }}>
          14 个专业 AI Agent &middot; 5+ 平台自动发布 &middot; 数据驱动持续优化
        </p>

        {/* CTAs — pill style */}
        <div className="mt-10 flex flex-col sm:flex-row items-start max-w-6xl mx-auto gap-4" style={{ animation: 'fade-up 1.4s ease-out' }}>
