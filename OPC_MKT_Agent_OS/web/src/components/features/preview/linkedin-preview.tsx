...
export function LinkedInPreview({ data }: LinkedInPreviewProps) {
  ...
  const showMore = data.body.length > 200;
  const displayBody = showMore ? data.body.slice(0, 200) : data.body;

  return (
    <BrowserFrame url="linkedin.com/feed">
      <div style={{ background: '#1b1f23', minHeight: '400px', padding: '12px' }}>
        {/* Post card */}
        <div
        ...
        >
          ...
          <div className="flex items-start gap-3 px-4 pt-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[12px]" style={{ color: 'rgba(255,255,255,0.6)' }}>
                {data.author.title ?? 'Marketing Lead'} at {data.author.company ?? 'Company'}
              </div>
          ...
          <div
            ...
            style={{
              background: data.mediaUrls[0]
                ...
                : 'linear-gradient(135deg, rgba(10,102,194,0.3), rgba(10,102,194,0.1))',
            }}
          />
          ...
          <div className="flex items-center justify-between px-4 py-1.5">
            <div className="flex items-center gap-1">
              ...
              <span className="text-[12px] ml-1" style={{ color: 'rgba(255,255,255,0.5)' }}>
                128
              </span>
            </div>
          ...
          >
            {[
              ...
              <button
                key={label}
                className="flex items-center gap-1.5 px-4 py-2.5 rounded-md text-[14px] font-medium transition-colors"
